    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-3 max-w-3xl text-muted-foreground">
          This is now the control room for both strategy rules and the required API keys. Add the Groww and AI
          provider keys here before you ask the app to fetch any trade idea. Marketaux stays optional, and the older
          INDstocks path is kept only as a legacy fallback.
        </p>
      </section>
